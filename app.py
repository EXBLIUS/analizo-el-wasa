...
# Ajustar el gráfico
# fig.update_layout(
#     title={'text': 'Mensajes con tigo por hora',
#              'y':0.96,
#              'x':0.5,
#              'xanchor': 'center'},
#     font=dict(size=17))
...
# Ajustar el gráfico
# fig.update_layout(
#     title={'text': 'Mensajes con ella por día', 'y':0.96, 'x':0.5, 'xanchor': 'center'},
#     font=dict(size=17))
